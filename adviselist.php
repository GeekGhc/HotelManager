...
$sql = "select * from advise ORDER BY `time` DESC limit " . ($page - 1) * 14 . ",14";
$news2 = array();
$news2=Db::assoc($sql);
$sql2 = "select * from advise";
$num=Db::getNum($sql2);
$number = ceil($num / 14);
?>
        ...
        <div class="content_middle" id="content_middle" style="width: 73%; margin-right: 0">
            <div class="news_content">
                            ...
                            foreach ($news2 as $key => $value) { ?>
                                <li style="width: 100%;height: 40px;border-bottom: 1px dotted #aaaaaa;box-sizing: border-box"><span
                                    ...
                                    <p style="width: 72%;float: left;height: 40px;line-height: 40px;font-size: 11pt">
                                        <a target= "_blank" href="news.php?flag=<?php echo $value['id']?>"
                ...
                <div class="news_page_fenye">
                    ...
                    <span style="width: 100%;"><a href="adviselist.php?id=1" style="color: <?php if ($page == 1) {
                            echo "lightgrey";
                        } ?>" onclick="<?php if ($page == 1) {
                            echo "return false";
                        } ?>">首页</a><a
                            href="adviselist.php?id=<?php echo $page - 1 ?>" style="color: <?php if ($page == 1) {
                            echo "lightgrey";
                        } ?>" onclick="<?php if ($page == 1) {
                            echo "return false";
                        } ?>">上一页</a>
                        ...
                        {
                            for($i=1;$i<=5;$i++){?>
                                <a href="adviselist.php?id=<?php echo $i ?>" style="color:<?php if ($page == $i) {
                                    echo "red";
                                } ?>"><?php echo $i ?></a>
                            <?php }}?>
                        ...
                        <a href="adviselist.php?id=<?php echo $page + 1 ?>" style="color: <?php if ($page == $number) {
                            echo "lightgrey";
                        } ?>" onclick="<?php if ($page == $number) {
                            echo "return false";
                        } ?>">下一页</a><a
                            href="adviselist.php?id=<?php echo $number ?>" style="color: <?php if ($page == $number) {
                            echo "lightgrey";
                        } ?>" onclick="<?php if ($page == $number) {
                            echo "return false";
                        } ?>">尾页</a><a>共有<?php echo $num ?>篇文章</a></span><span><a>共有<?php echo $number ?>页</a></span>
                    </p>
                </div>
            </div>
        </div>
